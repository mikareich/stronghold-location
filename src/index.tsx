    ...
    <div className="dark:bg-slate-900">
      <div className="prose dark:prose-invert container mx-auto p-10">
        ...
        <p>
          ...
          auch schon mal eine Festung gesucht und weißt, wieviel arbeit das ist.
          Aber wusstest du, dass du Festungen in Minecraft auch mit ein bisschen
          Mathematik und deutlich weniger Arbeit finden kannst?
        </p>
        <hr />
